...
#define SI446X_SPI hspi1
extern SPI_HandleTypeDef SI446X_SPI;

#define SI446X_CS_Port			GPIOA
#define SI446X_CS_Pin				GPIO_PIN_3

#define SI446X_EN_Port			GPIOA
#define SI446X_EN_Pin				GPIO_PIN_5

#define SI446X_IRQ_Port			GPIOA
#define SI446X_IRQ_Pin			GPIO_PIN_4

#define SI446X_CS_HIGH \
	HAL_GPIO_WritePin(SI446X_CS_Port,SI446X_CS_Pin,GPIO_PIN_SET)
	
#define SI446X_CS_LOW \
	HAL_GPIO_WritePin(SI446X_CS_Port,SI446X_CS_Pin,GPIO_PIN_RESET)
	
#define SI446X_EN_HIGH \
	HAL_GPIO_WritePin(SI446X_EN_Port,SI446X_EN_Pin,GPIO_PIN_SET)

#define SI446X_EN_LOW \
	HAL_GPIO_WritePin(SI446X_EN_Port,SI446X_EN_Pin,GPIO_PIN_RESET)
